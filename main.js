...
var a5 = Math.PI*7/11;
var a6 = Math.PI*7/12;
var a7 = Math.PI*15/12;
var a8 = Math.PI*19/12;
...
function drawAboutMeCircles() {
    ...
    ctx.drawImage(document.getElementById("profilePicture"), 110, 110, canvas.width-220, canvas.height-220);
    ctx.beginPath();
    ctx.lineWidth = 4;
    ...
    ctx.beginPath();
    ctx.lineWidth = 4;
    ctx.arc(canvas.width/2, canvas.height/2, canvas.height/2-75, a6, a6+Math.PI/3);
    ctx.stroke();
    ctx.beginPath();
    ctx.lineWidth = 3;
    ctx.arc(canvas.width/2, canvas.height/2, canvas.height/2-90, a7, a7+Math.PI*5/4);
    ctx.stroke();
    ctx.beginPath();
    ctx.lineWidth = 4;
    ctx.arc(canvas.width/2, canvas.height/2, canvas.height/2-105, a8, a8+Math.PI*7/4);
    ctx.stroke();
    a1 += 0.005;
    a2 += 0.0075;
    a3 -= 0.006;
